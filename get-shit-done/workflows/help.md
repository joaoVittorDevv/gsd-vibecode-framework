...
**`/gsd-ship [phase]`**
Merge work into base branch using an autogenerated semantic commit message following the <branch> <type>(<scope>) format.

- Performs semantic analysis on the phase context
- Executes Squash Merge locally to base branch
- Configures semantic commit title
- Updates STATE.md with shipping status

Prerequisites: Phase verified.
